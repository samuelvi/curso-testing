# ./vendor/behat/behat/bin/behat --config=tests/Functional/behat.yaml --suite=frontend_routing --tags=ROUTING_TABLE --tags=FRONTEND
# ./bin/behat --config app/config/behat.yml tests/Functional/Routing/Features/frontend.table.feature
@FRONTEND
@ROUTING_TABLE
@TABLE
