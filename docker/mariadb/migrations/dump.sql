...
grant all privileges on curso_testing_dev.* to curso_testing_dev@'localhost' identified by 'curso_testing_dev'  with grant option;
...
grant all privileges on curso_testing_test.* to curso_testing_test@'%' identified by 'curso_testing_test' with grant option;
flush privileges;
